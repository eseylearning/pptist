  ...
  <div class="element-positopn-panel">
    ...
    <ButtonGroup class="row">
      <Button
        ...
        ><IconBringToFront class="btn-icon" /> {{ t("ppt.moveUp") }}</Button
      >
      <Button
        style="flex: 1"
        @click="orderElement(handleElement!, ElementOrderCommands.DOWN)"
        ><IconSentToBack class="btn-icon" /> {{ t("ppt.moveDown") }}</Button
      >
    </ButtonGroup>
    ...
    <div class="row">
      <NumberInput
        ...
        style="width: 50%"
      >
        <template #prefix> {{ t("ppt.horizontal") }}:</template>
      </NumberInput>
      ...
      <NumberInput
        ...
        style="width: 50%"
      >
        <template #prefix> {{ t("ppt.vertical") }}:</template>
      </NumberInput>
    </div>
    ...
    <template v-if="handleElement!.type !== 'line'">
      <div class="row">
        <NumberInput
          ...
          style="width: 45%"
        >
          <template #prefix> {{ t("ppt.width") }}:</template>
        </NumberInput>
        <template
        ...
        >
          <IconLock
            ...
            v-tooltip="t('ppt.unlockAspectRatio')"
          ...
          <IconUnlock
            style="width: 10%"
            class="icon-btn"
            v-tooltip="t('ppt.lockAspectRatio')"
        ...
        <NumberInput
          ...
          style="width: 45%"
        >
          <template #prefix> {{ t("ppt.height") }}:</template>
        </NumberInput>
      </div>
    </template>
