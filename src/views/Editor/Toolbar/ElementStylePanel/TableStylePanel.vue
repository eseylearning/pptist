  ...
  <div class="table-style-panel">
    ...
    <ButtonGroup class="row" passive>
      <Popover trigger="click" style="width: 50%;">
        ...
        <TextColorButton first v-tooltip="t('ppt.fontColor')" :color="textAttrs.color">
          <IconText />
        </TextColorButton>
      </Popover>
      <Popover trigger="click" style="width: 50%;">
        ...
        <TextColorButton last v-tooltip="t('ppt.cellFill')" :color="textAttrs.backcolor">
          <IconFill />
        </TextColorButton>
      </Popover>
    </ButtonGroup>
    ...
    >
      <RadioButton value="left" v-tooltip="t('ppt.alignLeft')" style="flex: 1;"><IconAlignTextLeft /></RadioButton>
      <RadioButton value="center" v-tooltip="t('ppt.alignCenter')" style="flex: 1;"><IconAlignTextCenter /></RadioButton>
      <RadioButton value="right" v-tooltip="t('ppt.alignRight')" style="flex: 1;"><IconAlignTextRight /></RadioButton>
      <RadioButton value="justify" v-tooltip="t('ppt.alignJustify')" style="flex: 1;"><IconAlignTextBoth /></RadioButton>
    </RadioGroup>
    ...
    <div class="row">
      <div style="width: 40%;">{{ t('ppt.rowCount') }}：</div>
    ...
    <div class="row">
      <div style="width: 40%;">{{ t('ppt.columnCount') }}：</div>
      <div class="set-count" style="width: 60%;">
    ...
    <div class="row theme-switch">
      <div style="width: 40%;">{{ t('ppt.enableTableTheme') }}：</div>
