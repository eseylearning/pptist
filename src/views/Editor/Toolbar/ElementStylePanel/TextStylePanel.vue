<template>
  <div class="text-style-panel">
    ...
    <div class="row">
      <div style="width: 40%;">{{ t('ppt.paragraphSpace') }}：</div>
      <Select style="width: 60%;"
    ...
    <div class="row">
      <div style="width: 40%;">{{ t('ppt.wordSpace') }}：</div>
      <Select style="width: 60%;"
        :value="wordSpace || 0"
    ...
    <div class="row">
      <div style="width: 40%;">{{ t('ppt.textBoxFill') }}：</div>
