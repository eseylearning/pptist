<template>
  <div class="rich-text-base">
    ...
    >
      <RadioButton value="left" style="flex: 1" v-tooltip="t('ppt.alignLeft')"
        ><IconAlignTextLeft
      /></RadioButton>
      <RadioButton
        value="center"
        style="flex: 1"
        v-tooltip="t('ppt.alignCenter')"
        ><IconAlignTextCenter
      /></RadioButton>
      <RadioButton value="right" style="flex: 1" v-tooltip="t('ppt.alignRight')"
        ><IconAlignTextRight
      /></RadioButton>
      <RadioButton
        value="justify"
        style="flex: 1"
        v-tooltip="t('ppt.alignJustify')"
        ><IconAlignTextBoth
      /></RadioButton>
    </RadioGroup>
    ...
    <div class="row">
      <ButtonGroup style="flex: 1" passive>
        <Button
          first
          style="flex: 1"
          v-tooltip="t('ppt.decreaseParagraphIndent')"
      ...
      <ButtonGroup style="flex: 1" passive>
        <Button
          first
          style="flex: 1"
          v-tooltip="t('ppt.increaseParagraphIndent')"
          @click="emitRichTextCommand('indent', '+1')"
          ><IconIndentRight
        /></Button>
        <Popover trigger="click" v-model:value="indentRightPanelVisible">
          <template #content>
            <PopoverMenuItem @click="emitRichTextCommand('textIndent', '+1')"
              >{{ t("ppt.increaseFirstLineIndent") }}</PopoverMenuItem
            >
          </template>
          <Button last class="popover-btn"><IconDown /></Button>
        </Popover>
...
const updateLink = (link?: string) => {
  ...
  if (!link || !linkRegExp.test(link))
    return message.error(t("ppt.invalidLink"));
